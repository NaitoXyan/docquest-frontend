...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const loginResponse = await axios.post('http://web-production-4b16.up.railway.app/auth/token/login/', {
        email,
        password,
      });
      ...
      const userResponse = await axios.get('http://web-production-4b16.up.railway.app/name_and_roles', {
        headers: {
