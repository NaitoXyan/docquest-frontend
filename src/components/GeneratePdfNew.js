...
const MyDocument = () => (
  <Document>
    ...
    <Page style={styles.page}>
      ...
      <Text style={styles.textpadded}>Extension Project Proposal</Text>
      <View style={styles.table}>
        ...
        <View style={[styles.tableRow, {backgroundColor: '#a4b190'}]}>
          <View style={styles.tableCol1}>
        ...
        <View style={styles.tableRow}>
          ...
          <View style={[styles.tableCol2, {backgroundColor: '#a4b190'}]}>
