...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const loginResponse = await axios.post('https://web-production-4b16.up.railway.app/auth/token/login/', {
        email,
        password,
      });
      ...
      const userResponse = await axios.get('https://web-production-4b16.up.railway.app/name_and_roles', {
        headers: {
