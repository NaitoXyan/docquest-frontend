...
const CampusProposal = () => {
    ...
    const mockDocuments = [
        { id: 1, projectLeader: "Alice Johnson", documentType: "Campus Proposal", date: "2024-11-01", status: "Approved" },
        { id: 2, projectLeader: "Bob Smith", documentType: "Shared Trainers", date: "2024-11-15", status: "Pending" },
        { id: 3, projectLeader: "Cathy Lee", documentType: "Load Proposal", date: "2024-11-20", status: "Rejected" },
        { id: 4, projectLeader: "David Brown", documentType: "MOA/MOU", date: "2024-11-22", status: "Approved" },
    ];
                                ...
                                <tr key={index} className="bg-white">
                                    ...
                                    <td className="py-2 px-4">
                                        <div className="flex space-x-4">
                                            ...
                                            {/* Only show Upload Copy button if the document status is "Approved" */}
                                            {doc.status === "Approved" && (
                                                <NavLink
