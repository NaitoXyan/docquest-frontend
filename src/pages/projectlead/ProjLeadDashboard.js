                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    ...
                                    {currentProjects.map((project, index) => (
                                        <tr key={index}>
                                            ...
                                            <td style={{ width: "40%" }} className="px-6 py-4 whitespace-nowrap overflow-hidden text-ellipsis">
                                                <span title={project.projectTitle}>
                                                    {project.projectTitle.length > 42 ? `${project.projectTitle.slice(0, 42)}...` : project.projectTitle}
                                                </span>
                                            </td>
